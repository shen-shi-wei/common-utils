...
//        ZipUtils.toZip("D:/cs", fos1, true);

        /** 测试压缩方法2  */
//        List<File> fileList = new ArrayList<>();
//        fileList.add(new File("D:/main_test.py"));
//        fileList.add(new File("D:/main.py"));
//        fileList.add(new File("D:\\cs\\txt\\README.txt"));
//        fileList.add(new File("D:\\cs\\user\\user_2b8efd18f9f7fad9.jpg"));
//        fileList.add(new File("D:\\cs\\user\\user_3d6cf275f540ddc3.jpg"));
//        FileOutputStream fos2 = new FileOutputStream(new File("D:/mytest02.zip"));
//        ZipUtils.toZip(fileList, fos2);

        /**  测试解压 **/
//        unZipFiles("D:/mytest01.zip", "D://");
//        delDir("D:/cs");
    }
}